...
def main():
    ...
    while True:
        ...
        online_targets = tracker.update(detections, [height, width], [height, width], frame) # SORT expects a list of detections
        end_time = time.time()
        ...
        for t in online_targets:
            # print("DEBUG t:", t)
            x1, y1, x2, y2, tid, class_id = map(int, t) # add class_id
            w, h = x2 - x1, y2 - y1
