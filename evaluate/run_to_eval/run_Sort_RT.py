...
def main():
    ...
    out_tracking = cv2.VideoWriter(config.get('video', 'S_RT_out_5'), cv2.VideoWriter_fourcc(*'mp4v'), fps_video, (width, height))
    mot_output_path = config.get('annotations', 'anno_pred_5_RT_S')
