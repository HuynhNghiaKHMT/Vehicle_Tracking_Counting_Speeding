...
# Using .setdefault() is cleaner for initializing if not present
st.session_state.setdefault('run_processing', False)
st.session_state.setdefault('preview_frame', None)
st.session_state.setdefault('video_dims', (0, 0)) # (width, height)
st.session_state.setdefault('temp_video_path', None)
st.session_state.setdefault('last_uploaded_file_id', None)
st.session_state.setdefault('line_coords_config', None)
st.session_state.setdefault('source_points_config', None)
st.session_state.setdefault('target_width_real_config', 32)
st.session_state.setdefault('target_height_real_config', 140)
